...
The new `blendmode` property allows you to compose a custom blend mode outside of the defaults listed above. Here is an example function that codifies the construction of a custom blendmode:

```ruby
# see ./samples/07_advanced_rendering/20_ring for usage of a custom blend mode
